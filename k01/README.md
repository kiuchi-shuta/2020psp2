...
l.37: bufからscanfで数値文字列を実数としてvalに読み込む
...
l.39: ファイルを閉じる．閉じれないときは，即座にプログラム終了.
...
l.55:ave_onlineの関数(平均を求める)

l.59:var_onlineの関数(分散を求める)
...
## 修正履歴
[comment #20200705]
- プログラム自体はOKですが, ソースコードの説明におかしな部分があります. 
    - l.34, 35, 36  
    "関数を代入"というのはおかしいです. "平均を計算する"などといった表現で良いと思います. 
    - l.36  
    分散ではなく, 平均だと思います.  
    また, 累乗というと2乗以外も意味するので, ここでは2乗と書いた方が良いです. 
